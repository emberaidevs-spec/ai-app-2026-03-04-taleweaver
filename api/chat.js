export default async function handler(req, res) {
  try {
    ...
    const { tone, style, genre, prompt } = JSON.parse(body);
    ...
    const systemPrompt = `Generate a ${genre} story or poem in the style of ${style} with a ${tone} tone. The story or poem should be based on the following prompt: ${prompt}.`;
